...
<div
	...
	role="group"
	aria-label="<?php esc_attr_e( 'Booking Details', 'tour-service-date-selector' ); ?>"
>
	...
	>
		...
		<?php // Flatpickr inline calendar container. ?>
		<div
			class="tsds-calendar-container"
			id="tsds-calendar-container"
			role="application"
